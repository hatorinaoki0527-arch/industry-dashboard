...
function renderUS(){
 ...
 if(china&&selected)detail='<section class="panel"><button class="button" data-us-back>← 全部行业</button><h2>'+esc(selected.name)+'</h2></section>'+(cnStockCode?'':cnIndustryTrends(selected.code,days,usDate))+cnStockPanel(selected.code)+(cnStockCode?'':detail);
